...
// # Equipment - Embla (hno=3)
    ...
    "card_equip_3_24" => [ 
        ...
        "durability" => 2,
        "r" => "gainDamage:1preventDamage;1drawEvent",
        "on" => "damage",
...
// # Equipment - Finkel (hno=5)
    ...
    "card_equip_5_16" => [ 
        ...
        "durability" => 3,
        "r" => "gainDamage:(2heal(adj))/(2damage(adj))",
...
// # Events - Embla (hno=3)
    "card_event_3_30" => [ 
        ...
        "count" => 2,
        "r" => "2damage('adj && (rank==3 or legend)')",
