    ...
    function addGeneratedTokens() {
        $this->token_types += [
            ...
            "card_ability_1_12" => [
                ...
                "on" => "actionAttack",
                "effect" =>
                    "Add damage to your attack action based on the distance to the target (e.g. add 3 damage if the target is 3 areas away).",
            ...
            "card_ability_1_13" => [
                ...
                "on" => "monsterKilled",
                "effect" =>
                    "If you kill a monster in an attack action, all remaining damage may be dealt to a second monster behind it (adjacent and further away).",
            ],
            "card_ability_1_14" => [
                "ctype" => "ability",
                ...
                "on" => "monsterKilled",
                "effect" =>
                    "If you kill a monster in an attack action, all remaining damage may be dealt to the next monster behind it (adjacent and further away), and so on.",
            ],
            "card_ability_1_7" => [
                "ctype" => "ability",
            ...
            "card_ability_1_5" => [
                ...
                "on" => "monsterMove",
                "effect" =>
                    "Once per monster turn, prevent a rank 1 or rank 2 monster within range 3 from moving. You cannot choose the same monster next turn.",
            ],
            "card_ability_1_6" => [
                "ctype" => "ability",
                ...
                "on" => "monsterMove",
                "effect" =>
                    "Once per monster turn, prevent a monster within range 3 from moving. You cannot choose the same monster next turn.",
            ],
            "card_ability_1_3" => [
                "ctype" => "ability",
            ...
            "card_ability_2_14" => [
                ...
                "r" => "custom",
                "effect" =>
                    "1[MANA]: Move +1.<br>2[MANA]: Attack range +1 this turn.<br>2[MANA]: Add 2 damage to your attack action.<br>2[MANA]: Draw 1 card.",
            ],
            "card_ability_2_3" => [
                "ctype" => "ability",
            ...
            "card_ability_2_10" => [
                ...
                "on" => "monsterMove",
                "effect" =>
                    "Once per monster turn, prevent any monster within range 3 from moving. You cannot choose the same monster next turn.",
            ],
            "card_ability_2_5" => [
                "ctype" => "ability",
            ...
            "card_ability_2_6" => [
                ...
                "r" => "custom",
                "effect" =>
                    "Move into an adjacent forest area, or move out of a forest area. Each time you move into a forest area, heal 1 damage.",
            ...
            "card_ability_4_5" => [
                ...
                "on" => "actionAttack",
                "effect" =>
                    "Add 1 damage to each attack action. If an adjacent monster is killed in your attack action, any remaining damage may be dealt to a second monster in clockwise order.",
            ],
            "card_ability_4_6" => [
                "ctype" => "ability",
                ...
                "on" => "actionAttack",
                "effect" =>
                    "Add 1 damage per adjacent monster to each attack action. If an adjacent monster is killed in your attack action, any remaining damage may be dealt to a second monster in clockwise order.",
            ],
            "card_ability_4_7" => [
                "ctype" => "ability",
            ...
            "card_equip_1_16" => [
                ...
                "strength" => 3,
                "durability" => "actionAttack",
                "r" => "counter(countRunes):dealDamage(adj_attack)",
                "quest" => "<i>Spend a mend action on Nailfare</i> to bind the relics.",
                "effect" =>
                    "This is your Main Weapon. Attack range 2.<br>Count the [RUNE] rolled in each attack action and deal that much damage to another monster adjacent to the target.",
            ...
            "card_equip_2_19" => [
                ...
                "effect" =>
                    "This is your Main Weapon. Attack range 2.<br>Whenever you roll [RUNE], add another [DIE_ATTACK] to your roll for each [RUNE].",
            ...
            "card_equip_4_17" => [
                ...
                "effect" =>
                    "[DAMAGE]: Gain 2 gold [XP] if you stand adjacent to a mountain area.<br>[DAMAGE]: Gain 3 gold [XP] if you stand adjacent to 3 mountain areas.",
            ...
            "card_equip_4_21" => [
                ...
                "effect" =>
                    "This is your Main Weapon. If you kill a monster in an attack action, any excess damage may be stored here (max 3 stored). Damage stored here may be added to your attack action.",
            ...
            "card_event_1_34" => [
                ...
                "count" => 1,
                "r" => "[0,2]moveHero(locationOnly),0setAtt(move)",
            ...
            "card_event_2_30" => [
                ...
                "count" => 2,
                "r" => "2spendMana(grimheim):addTownPiece",
            ...
            "card_event_4_33" => [
                ...
                "name" => clienttranslate("Focus"),
                "count" => 2,
                "r" => "spendAction(actionFocus):gainXp:gainMana(1):drawEvent",
            ...
            "card_hero_1_1" => [
                ...
                "flavour" =>
                    "Bjorn is the self-made man. At least, his clothes are self-made.<br>Not much of them remain - he learned from an early age that he must rip what he has sewn.<br>With his great strength, his needles and arrows can pierce anything.",
            ],
            "card_hero_1_2" => [
                "ctype" => "hero",
            ...
            "card_hero_2_1" => [
                ...
                "flavour" =>
                    "Alva learned archery from her father at an early age. She can hit a butterfly at 50 paces, but she would never dream of doing that - butterflies are pretty!",
            ],
            "card_hero_2_2" => [
                "ctype" => "hero",
                ...
                "flavour" =>
                    "I don't understand why I should keep my distance? After all, they are only three trolls, and I have many more than three arrows.",
            ],
            "card_hero_3_1" => [
                "ctype" => "hero",
                ...
                "effect" => "Move 4.",
                "flavour" =>
                    "Embla is fast, really tough, and passionately competetive. She is inarguably the best defender of Grimheim... because you just don't argue with her.",
            ],
            "card_hero_3_2" => [
                "ctype" => "hero",
            ...
            "card_hero_4_1" => [
                ...
                "flavour" =>
                    "Ants can carry several times their own body weight. So can Boldur. He's forging his thick armor to prove this point, and promote heavy metal.",
            ],
            "card_hero_4_2" => [
                "ctype" => "hero",
                ...
                "effect" => "Armor. (Always prevents 1 damage)",
                "flavour" =>
                    "Going berserk at the local inn, Boldur spent a drunken evening challenging all visitors to arm-wrestling. He broke the tavern record as well as fifteen arms, earning him the nickname the Arm-y.",
            ],
