...
// # Equipment - Bjorn (hno=1)
    ...
    "card_equip_1_19" => [ 
        ...
        "durability" => 3,
        "r" => "spendUse:costDamage:2heal(adj)",
    ...
    "card_equip_1_17" => [ 
        ...
        "durability" => 2,
        "r" => "spendUse:costDamage:3roll(adj)",
    ...
    "card_equip_1_22" => [ 
        ...
        "strength" => 3,
        "r" => "on(EventActionAttack):addDamage(true,trollkin)",
        "on" => "EventActionAttack",
...
// # Equipment - Embla (hno=3)
    ...
    "card_equip_3_24" => [ 
        ...
        "durability" => 2,
        "r" => "costDamage:1preventDamage,drawEvent",
...
// # Equipment - Boldur (hno=4)
    ...
    "card_equip_4_26" => [ 
        ...
        "durability" => 3,
        "r" => "spendUse:costDamage:dealDamage(adj)",
