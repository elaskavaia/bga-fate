...
// # Abilities - Bjorn (hno=1)
    ...
    "card_ability_1_3" => [ 
        ...
        "mana" => 1,
        "r" => "3spendMana:3dealDamage(inRange)",
...
// # Abilities - Embla (hno=3)
    ...
    "card_ability_3_13" => [ 
        ...
        "r" => "dealDamage('adj && !legend');1moveMonster",
    ...
    "card_ability_3_14" => [ 
        ...
        "r" => "2dealDamage('adj && !legend');2moveMonster",
...
// # Abilities - Boldur (hno=4)
    ...
    "card_ability_4_3" => [ 
        ...
        "mana" => 1,
        "r" => "3spendMana:performAction(actionAttack)",
...
// # Equipment - Embla (hno=3)
    ...
    "card_equip_3_24" => [ 
        ...
        "durability" => 2,
        "r" => "gainDamage:1preventDamage,drawEvent",
...
// # Equipment - Finkel (hno=5)
    ...
    "card_equip_5_16" => [ 
        ...
        "durability" => 3,
        "r" => "gainDamage:(2heal(adj))/(2dealDamage(adj))",
