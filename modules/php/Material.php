...
// # spawn format: monster_type:hex_q_r (comma-separated for multiple spawns)
...
// # Yellow regular (7-36)
    ...
    "card_monster_9" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 9,
        "name" => clienttranslate("Trekking Monsters"),
        "spawnloc" => "Highlands",
],
    "card_monster_10" => [ 
        "ctype" => "yellow",
    ...
    "card_monster_11" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 11,
        "name" => clienttranslate("Autumn Claw"),
        "spawnloc" => "Highlands",
],
    "card_monster_12" => [ 
        "ctype" => "yellow",
    ...
    "card_monster_14" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 14,
        "name" => clienttranslate("Autumn Youth Camp"),
        "spawnloc" => "SpewingMountain",
],
    "card_monster_15" => [ 
        "ctype" => "yellow",
    ...
    "card_monster_22" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 22,
        "name" => clienttranslate("Impulsive Swarm"),
        "spawnloc" => "DeadPlains",
],
    "card_monster_23" => [ 
        "ctype" => "yellow",
    ...
    "card_monster_30" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 30,
        "name" => clienttranslate("Krusty the Babysitter"),
        "spawnloc" => "OgreValley",
],
    "card_monster_31" => [ 
        "ctype" => "yellow",
    ...
    "card_monster_36" => [ 
        ...
        "type" => "card card_monster ctype_yellow",
        "num" => 36,
        "name" => clienttranslate("Feral Trolls"),
        "spawnloc" => "DarkForest",
],
...
// # Red regular (43-54)
    ...
    "card_monster_47" => [ 
        ...
        "type" => "card card_monster ctype_red",
        "num" => 47,
        "name" => clienttranslate("Walking Armies"),
        "spawnloc" => "MarshOfSorrow",
],
    "card_monster_48" => [ 
        "ctype" => "red",
        ...
        "type" => "card card_monster ctype_red",
        "num" => 48,
        "name" => clienttranslate("Gloomy Fate"),
        "spawnloc" => "MarshOfSorrow",
],
    "card_monster_49" => [ 
        "ctype" => "red",
        ...
        "type" => "card card_monster ctype_red",
        "num" => 49,
        "name" => clienttranslate("Ragar Summoning"),
        "spawnloc" => "DeadPlains",
],
    "card_monster_50" => [ 
        "ctype" => "red",
    ...
    "card_monster_51" => [ 
        ...
        "type" => "card card_monster ctype_red",
        "num" => 51,
        "name" => clienttranslate("Travelogue"),
        "spawnloc" => "OgreValley",
],
    "card_monster_52" => [ 
        "ctype" => "red",
        ...
        "type" => "card card_monster ctype_red",
        "num" => 52,
        "name" => clienttranslate("Primal Breezes"),
        "spawnloc" => "OgreValley",
],
    "card_monster_53" => [ 
        "ctype" => "red",
