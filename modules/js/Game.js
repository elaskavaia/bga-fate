...
class Game extends Game1Tokens {
        ...
        <div id="pboard_${color}" class="pboard">
          ...
          <div id="aslot_${color}_empty_2" class="pboard_slot aslot aslot_empty"></div>
            ...
            Object.values(gamedatas.players).forEach((player) => {
                ...
                const handComposite = this.wrapComposite($(`counter_hand_${color}`), $(`tracker_hand_${color}`), "minicomposite_hand wicon_hand wicon");
    ...
    wrapComposite(first, second, classes = "") {
        var _a, _b;
        ...
        (_a = first.dataset).state ?? (_a.state = "0");
        (_b = second.dataset).state ?? (_b.state = "0");
    ...
    buildLegendTooltip(tokenInfo) {
        ...
        if (specialAbility[abilityKey])
            tokenInfo.tooltip += this.ttSection(_("Ability"), specialAbility[abilityKey]);
