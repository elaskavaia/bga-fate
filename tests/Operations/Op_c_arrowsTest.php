...
final class Op_c_arrowsTest extends TestCase {
    private GameUT $game;
    ...
    private function createOp(): Op_c_arrows {
        /** @var Op_c_arrows */
        $op = $this->game->machine->instanciateOperation("c_arrows", PCOLOR);
        return $op;
    }
    ...
    public function testMonsterInRangeIsTarget(): void {
        ...
        $op = $this->createOp();
        $info = $op->getArgsInfo();
        $this->assertArrayHasKey("hex_12_1", $info);
    }
    ...
    public function testUsesAttackRangeNotAdjacent(): void {
        ...
        $op = $this->createOp();
        $info = $op->getArgsInfo();
        $this->assertArrayHasKey("hex_14_2", $info);
    }
    ...
    public function testDeal1DamageOnPlains(): void {
        ...
        $op = $this->createOp();
        $op->action_resolve([Operation::ARG_TARGET => "hex_13_2"]);
    ...
    public function testDeal2DamageInForest(): void {
        ...
        $this->game->tokens->moveToken("monster_goblin_1", "hex_12_1");
        $op = $this->createOp();
        $op->action_resolve([Operation::ARG_TARGET => "hex_12_1"]);
