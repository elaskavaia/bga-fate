 ...
 * cleave, Nailed Together pierce), the player gains XP/gold for EVERY monster
...
class Campaign_MultiKillXpBugTest extends CampaignBaseTest {
    ...
    /**
     * Sweeping Strike I kills the primary goblin AND cleaves a second monster dead in one
    ...
    public function testSweepMultiKillAwardsXpForEveryMonster(): void {
        ...
        $this->assertEquals("supply_monster", $this->tokenLocation($cleave), "cleave brute dead");
