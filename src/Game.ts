  ...
  updateTokenDisplayInfo(tokenInfo: TokenDisplayInfo) {
    ...
    switch (mainType) {
      ...
      case "hero": {
        ...
        tokenInfo.tooltip = "";
        if (strength != null) tokenInfo.tooltip += this.ttSection(_("Strength"), String(strength));
        if (health != null) tokenInfo.tooltip += this.ttSection(_("Health"), String(health));
        if (range != null) tokenInfo.tooltip += this.ttSection(_("Range"), String(range));
        break;
      }
      case "house": {
